subroutine Bootstrap60
 ...
 real(8) :: te60,ti60,ne60,dte60,dti60,dne60
 ...
 do i = 1,imax
     ne60 = 1.d+13*ne60_(i)    !cm^-3
     te60 = 1.6022d-12*Te60_(i) !erg
     ti60 = 1.6022d-12*Ti60_(i) !erg
     dne60 = 1.d+13*Dne60_(i)
     dte60 = 1.6022d-12*DTe60_(i)
     dti60 = 1.6022d-12*DTi60_(i)
     jb(i) = ne60*q(x_(i))*(2.44*(te1+ti1)*dne60/ne60 + 0.69*dte60 - 0.42*dti60)
 ...
 open(11, file="data/Bootstrap60.dat")
 open(12, file="data/QG60.dat")
 do i = 1, imax
